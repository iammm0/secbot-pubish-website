---
title: "工具扩展"
description: "实现 BaseTool、注册工具、验证工具列表、直接执行和敏感工具维护建议。"
---
...
- 新增工具后同步更新 [TS_MIGRATION_STATUS.md](https://github.com/iammm0/secbot/blob/release/docs/TS_MIGRATION_STATUS.md) 中的工具总数和分类统计。
