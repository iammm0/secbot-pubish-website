---
title: "部署"
description: "从源码部署后端、TUI 与后端边界、Release 包、systemd、验证与排障。"
---
...
- [API.md](/docs/secbot/api)
- [QUICKSTART.md](https://github.com/iammm0/secbot/blob/release/docs/QUICKSTART.md)
- [LLM_PROVIDERS.md](/docs/secbot/llm-providers)
- [OLLAMA_SETUP.md](https://github.com/iammm0/secbot/blob/release/docs/OLLAMA_SETUP.md)
- [RELEASE.md](https://github.com/iammm0/secbot/blob/release/docs/RELEASE.md)
