...
基于 [Next.js](https://nextjs.org) 的 Secbot 发布与文档门户：首页、下载说明、**站内文档**（Markdown 渲染）与更新日志等。文档正文由上游 Secbot 的 `docs/` 同步至本仓库 [`docs/`](./docs/)，**仅在站内** `/docs`、`/docs/view/...` 预览，不依赖跳转到 GitHub 阅读文档。
